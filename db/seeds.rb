...
user3 = User.create!(email: "luca@gmail.com", password: "password", password_confirmation: "password", first_name: "Luca", last_name: "Scanu", mobile: "07960143459", address: "9 Sydney Street", postcode: "NW2 4AL", image: "http://i.imgur.com/az0Wwnm.jpg", dob: "1994-06-25", bio: "Pretending to be other people since 1994...")

user4 = User.create!(email: "sharon@gmail.com", password: "password", password_confirmation: "password", first_name: "Sharon", last_name: "Phillips", mobile: "07960143459", address: "10 Sydney Street", postcode: "NW3 4AL", image: "http://i.imgur.com/0QMMh2f.jpg", dob: "1970-07-08", bio: "Happy. Free. Confused. Lonely. At the same time.")

user5 = User.create!(email: "hot_male@hotmail.com", password: "password", password_confirmation: "password", first_name: "Musty", last_name: "Musty", mobile: "07960143459", address: "13 Sydney Street", postcode: "NW1 4AL", image: "http://i.imgur.com/IgjSJRM.jpg", dob: "1981-05-13", bio: "My views are not my own and are associated with really massive corporations")
...
user7 = User.create!(email: "hudhayfa@gmail.com", password: "password", password_confirmation: "password", first_name: "Hudhayfa", last_name: "Man", mobile: "07960143459", address: "9 Sydney Street", postcode: "NW2 4AL", image: "http://i.imgur.com/N01PAoj.jpg", dob: "1988-01-18", bio: "The man himself")
