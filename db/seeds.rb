...
Thank you!", location: "8 Guilford Cresent", postcode: "E5 6HY", datetime: "2017-03-02 11:00:00 Z", owner_id: user2.id, rate: 20, image: "http://i.imgur.com/0JUvOOB.jpg")
...
With water jabberja out I'm going to close the water tap and the water tap. Since I have not confirmed returning to the room, I am worried whether the water has stopped properly. We are looking for someone who will check if we closed the tap of the tap.", location: "8 Guilford Cresent", postcode: "E5 6HY", datetime: "2017-03-02 08:00:00 Z", owner_id: user6.id, rate: 20, image: "http://i.imgur.com/xlak3bf.jpg")

job10 = Job.create!(title: "Maid", description: "I will go to Eniwa-shi, Hokkaido in April 2017. I will hire a maid from April. You can contact with mail. If anyone is interested in this job.", location: "8 Guilford Cresent", postcode: "E5 6HY", datetime: "2017-03-02 10:15:00 Z", owner_id: user7.id, rate: 25, image: "http://i.imgur.com/cYcFGyv.jpg")

job11 = Job.create!(title: "Translator", description: "I am waiting for an English presentation / speech. For the time being I made the manuscript, but there is more expressive expression. Is it okay to keep my own pronunciation of katakana English? Those who are worrying. Correct to native speaking pronunciation in one hour.", location: "8 Guilford Cresent", postcode: "E5 6HY", datetime: "2017-03-10 13:00:00 Z", owner_id: user7.id, rate: 21, image: "http://i.imgur.com/PKJL5ri.jpg")

job12 = Job.create!(title: "Fix my pi", description: "I do not ask the model, but ideally it is possible to have as many varieties as possible!", location: "8 Guilford Cresent", postcode: "E5 6HY", datetime: "2017-03-04 11:00:00 Z", owner_id: user3.id, rate: 20, image: "http://i.imgur.com/SLJNMqq.jpg")
